...
#define CONV_REDOX( \
  ...
  k43, k44, k45, k46, k47,        k50, k51, k52, k53, k54, \
     ...
     OS_LSFT ,k29     ,k30     ,k31     ,k32     ,k33     ,KC_DEL  ,                          KC_BSPC ,k36     ,k37     ,k38     ,k39     ,k40 ,    KC_SCLN , \
     KC_LSFT ,k43     ,k44     ,k45     ,k46     ,k47     ,KC_NO   ,QK_BOOT ,        QK_BOOT ,KC_NO   ,k50     ,k51     ,k52     ,k53     ,k54     ,KC_RSFT , \
     KC_LCTL ,KC_BSLS ,KC_LPRN ,KC_RPRN   ,      k59     ,    k60     ,k61     ,        k64      ,k65     ,k66     ,KC_LBRC ,KC_RBRC ,KC_SLASH   ,KC_NO 

#define REDOX(k) CONV_REDOX(k)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[ALPHA]  = LAYOUT_redox(REDOX(_PUQ)),	
